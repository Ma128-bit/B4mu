...
def QuadMuVar(rdf, branches, analysis_type):
    quadruplet_related_var = ["RefittedSV_Mass_err", "RefittedSV_Mass", "Quadruplet_Mass", "FlightDistBS_SV_Significance", "QuadrupletVtx_Chi2", "QuadrupletVtx_NDOF","Quadruplet_Charge", "QuadrupletVtx_x", "QuadrupletVtx_y", "QuadrupletVtx_z", 
