...
void Fit2mu2K(TString dataFile="../Analysis/FinalFiles_B2mu2K/Analyzed_Data_B2mu2K_2022.root", TString var="Ditrk_mass", float down=1.002, float up=1.05) {
    ...
    RooRealVar nsig2("nsi2g", "Numero di segnali2", 200000, 10000, 400000);
...
void Fit2muKpi(TString dataFile="../Analysis/FinalFiles_B2muKpi/Analyzed_Data_B2muKpi_2022.root", TString var="Ditrk_mass", float down=0.82, float up=1.05) {
    ...
    // Creare il modello di fit combinando fondo e gaussiana
    RooRealVar nsig("nsig", "Numero di segnali", 2500000, 10000, 5000000);
    RooRealVar nsig2("nsi2g", "Numero di segnali2", 800000, 10000, 2000000);
    RooRealVar nbkg("nbkg", "Numero di background",3000000, 1000000, 10000000);
...
void Fit2mu2KM(TString year="2022") {
    ...
    // Creare la gaussiana
    RooRealVar mean("mean", "Media gaussiana", (up+down)/2, down, up);
    RooRealVar sigma("sigma1", "Deviazione standard gaussiana", 0.02, 0.001, 0.2);
    RooGaussian voigt_pdf("voigt_pdf", "Signal Gaussian PDF", x, mean, sigma);

    // Creare la gaussiana
    RooRealVar mean2("mean2", "Media gaussiana2", (up+down)/2, down, up);
    RooRealVar sigma2("sigma2", "Deviazione standard gaussiana2", 0.05, 0.001, 0.2);
    RooGaussian voigt_pdf2("voigt_pdf2", "Signal Gaussian PDF2", x, mean, sigma2);
...
void Fit2mu2KMC(TString year="2022", TString addition="_Kpi_with") {
    ...
    // Creare la gaussiana
    RooRealVar mean("mean", "Media gaussiana", (up+down)/2, down, up);
    RooRealVar sigma("sigma1", "Deviazione standard gaussiana", 0.02, 0.001, 0.07);
    RooGaussian voigt_pdf("voigt_pdf", "Signal Gaussian PDF", x, mean, sigma);

    // Creare la gaussiana
    RooRealVar mean2("mean2", "Media gaussiana2", (up+down)/2, down, up);
    RooRealVar sigma2("sigma2", "Deviazione standard gaussiana2", 0.05, 0.001, 0.07);
    RooGaussian voigt_pdf2("voigt_pdf2", "Signal Gaussian PDF2", x, mean, sigma2);
...
void Fit2muKpiMC(TString year="2022", TString addition="_2K_with") {
    ...
    // Creare la gaussiana
    RooRealVar mean("mean", "Media gaussiana", (up+down)/2, down, up);
    RooRealVar sigma("#sigma_{1}", "Deviazione standard gaussiana", 0.02, 0.001, 0.08);
    RooGaussian voigt_pdf("voigt_pdf", "Signal Gaussian PDF", x, mean, sigma);

    // Creare la gaussiana
    RooRealVar mean2("mean2", "Media gaussiana2", (up+down)/2, down, up);
    RooRealVar sigma2("#sigma_{2}", "Deviazione standard gaussiana2", 0.05, 0.001, 0.08);
    RooGaussian voigt_pdf2("voigt_pdf2", "Signal Gaussian PDF2", x, mean, sigma2);
    ...
    TCanvas *canvas = new TCanvas("canvas", "Fit Result", 900, 600);
    frame->Draw();
    canvas->SaveAs("Fit2muKpiMC"+addition+"_"+year+".png");
