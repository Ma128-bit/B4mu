...
if __name__ == "__main__":
    ...
    rdf = rdf.Filter("abs(Ditrk_mass-1.01945)<0.01 && abs(Dimu_mass-3.0969)<0.15 && vtx_prob>0.02 && Quadruplet_Pt>9.5")
    ...
    nsig2 = RooFormulaVar("nsig2", "nsig2", "@0/29.46", ROOT.RooArgList(nsig))
