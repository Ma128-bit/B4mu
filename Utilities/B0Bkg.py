...
if __name__ == "__main__":
    ...
    simPdf.plotOn(frame1,RooFit.Slice(sample,"Bs"),RooFit.Components(signal_B0),RooFit.ProjWData(sample,combData), RooFit.LineColor(kRed), RooFit.LineStyle(kDashed))
    ...
    simPdf.plotOn(frame2, RooFit.Slice(sample,"B0"), RooFit.Components(Rsignal_B0), RooFit.ProjWData(sample,combData), RooFit.LineColor(kRed), RooFit.LineStyle(kDashed))
