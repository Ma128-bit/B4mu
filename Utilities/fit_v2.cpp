...
void fit_v2() {
    ...
    TFile *file = new TFile("../Analysis/FinalFiles/Analyzed_Data_2022.root");
    ...
    tree->Draw("Quadruplet_Mass_eq>>h1(52,5.0, 5.9)","(isJPsiPhi==1 &&(isMedium[0]+isMedium[1]+isMedium[2]+isMedium[3]==4) && vtx_prob>0.01)");
