...
combine -M AsymptoticLimits --cl 0.95 datacardA.txt >> ../output_combineA.txt
combine -M AsymptoticLimits --cl 0.95 datacardB.txt >> ../output_combineB.txt
combine -M AsymptoticLimits --cl 0.95 datacardC.txt >> ../output_combineC.txt
