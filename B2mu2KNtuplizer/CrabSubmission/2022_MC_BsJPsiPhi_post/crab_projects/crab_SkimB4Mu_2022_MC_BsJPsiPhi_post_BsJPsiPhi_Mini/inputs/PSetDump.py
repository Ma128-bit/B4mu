...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/mc/Run3Summer22EEMiniAODv4/BsToJpsiPhi_JMM_PhiMM_MuFilter_SoftQCDnonD_TuneCP5_13p6TeV-pythia8-evtgen/MINIAODSIM/130X_mcRun3_2022_realistic_postEE_v6-v2/2540000/cc3d6df7-e414-440f-b27b-bc0a0cfdb641.root')
)
...
process.FourMuonsCand = cms.EDProducer("CandViewShallowCloneCombiner",
...
process.FourMuonsVtxKalmanFit = cms.EDProducer("KalmanVertexFitCompositeCandProducer",
    src = cms.InputTag("FourMuonsCand")
)


process.FourMuonsVtxKinFit = cms.EDProducer("KinematicVertexFitCompositeCandProducer",
    src = cms.InputTag("FourMuonsCand")
)
...
process.patGenericParticles = cms.EDProducer("PATGenericParticleProducer",
    addEfficiencies = cms.bool(False),
    addGenMatch = cms.bool(False),
    ...
    embedCaloTower = cms.bool(False),
    embedCombinedMuon = cms.bool(False),
    embedGenMatch = cms.bool(False),
    embedGsfTrack = cms.bool(False),
    embedMultipleTracks = cms.bool(False),
    embedStandAloneMuon = cms.bool(False),
    embedSuperCluster = cms.bool(False),
    embedTrack = cms.bool(False),
    genParticleMatch = cms.InputTag("REPLACE_ME"),
    isoDeposits = cms.PSet(

    ),
    qualitySource = cms.InputTag("REPLACE_ME"),
    resolutions = cms.PSet(
...
process.B4MuHLTFilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_DoubleMu4_3_LowMass*'),
...
process.FourMuonsCandFilter = cms.EDFilter("CandViewCountFilter",
    minNumber = cms.uint32(1),
    src = cms.InputTag("FourMuonsCand")
)


process.FourMuonsFilter = cms.EDFilter("CandViewCountFilter",
...
process.InitialPlots = cms.EDAnalyzer("SimpleEventCounter",
    muonsInputTag = cms.InputTag("slimmedMuons")
)


process.PlotsAfter4Muons = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterBCand = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterBCandSel = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterLooseMuon = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterTrigger = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("slimmedMuons")
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('130X_mcRun3_2022_realistic_postEE_v6'),
...
process.FourMuonSelSeq = cms.Sequence(process.InitialPlots+process.B4MuHLTFilter+process.PlotsAfterTrigger+process.looseMuons+process.PlotsAfterLooseMuon+process.FourMuonsFilter+process.PlotsAfter4Muons+process.FourMuonsCand+process.FourMuonsCandFilter+process.PlotsAfterBCand+process.FourMuonsVtxKalmanFit)


process.B4MuSkim = cms.Path(process.FourMuonSelSeq+process.unpackedPatTrigger+process.TreeMakerBkg)
