...
process.load("B4mu_Ntuplizer.SkimTools.B4MuSkim_miniAOD_cff")
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
      "file:/afs/cern.ch/user/m/mbuonsan/B_4mu/B4mu_Ntuple_Analysis/CMSSW_13_0_13/src/B4mu/SkimTools/test/Run3_Bd4Mu_step2_322.root"
