...
private:
    ...
    std::vector<double> mu1_pfreliso03, mu2_pfreliso03, mu3_pfreliso03, mu4_pfreliso03, mu1_bs_dxy_sig, mu2_bs_dxy_sig, mu3_bs_dxy_sig, mu4_bs_dxy_sig, vtx_prob, vtx_prob_1;
